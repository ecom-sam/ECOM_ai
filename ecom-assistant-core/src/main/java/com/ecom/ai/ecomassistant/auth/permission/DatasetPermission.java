...
public enum DatasetPermission implements Permission {
    ...
    DATASET_VIEW("dataset:view", "dataset", "查詢知識庫", "查詢知識庫"),
    DATASET_DELETE("dataset:delete", "dataset", "刪除知識庫", "刪除知識庫"),
    DATASET_MANAGE("dataset:manage", "dataset", "知識庫基本訊息管理", "知識庫基本訊息管理"),
    DATASET_VISIBILITY_MANAGE("dataset:visibility:manage", "dataset", "知識庫開放設定", "知識庫開放設定"),
